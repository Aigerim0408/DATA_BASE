...
def create_products(conn):
    ...
    create_product(conn, ('Мороженое: Сникерс', 60.53, 30))  # 2
    create_product(conn, ('Кола 2л', 135.00, 4))  # 3
    create_product(conn, ('NITRO', 62.40, 12))  # 4
    create_product(conn, ('Чипсы', 34.90, 5))  # 5
    ...
    create_product(conn, ('Порошок "PERSIL"', 250.00, 3))  # 14
